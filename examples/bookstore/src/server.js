...
const DESCRIPTOR_PATH = path.join(__dirname, '..', 'proto', 'bookstore_descriptor.bin');
...
const BookStoreService = proto.bookstore.v1.BookStoreService.service;
...
// Register BookStore handlers
server.addService(BookStoreService, handlers);
...
server.bindAsync(`0.0.0.0:${PORT}`, grpc.ServerCredentials.createInsecure(), (err, port) => {
  ...
  console.log(`BookStore gRPC server listening on port ${port}`);
